...
/*:
 * @target MZ
 * @plugindesc [v1.0.3] Tela de Opções Personalizada - Ancient Souls
 * @author 
 ...
 *
 * @help
 * AS_1.3_OptionsScreen_Agent [v1.0.3]
 * 
 * ============================================================================
 * Descrição:
 * ============================================================================
...
(() => {
    ...
    class OptionsScreenManager {
        ...
        closeOptions() {
            ...
            this.log(`📍 SceneManager._stackLength: ${SceneManager._stackLength}`);
            
            // Log debug da stack completa
            for (let i = 0; i < SceneManager._stackLength; i++) {
                const scene = SceneManager._scene_stack[i];
                this.log(`  Stack[${i}]: ${scene ? scene.constructor.name : 'undefined'}`);
            }
