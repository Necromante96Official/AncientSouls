...
/*:
 * @target MZ
 * @plugindesc [v1.0.0] Tela de Opções Personalizada - Ancient Souls
 * @author 
 ...
 *
 * @help
 * AS_1.3_OptionsScreen_Agent [v1.0.0]
 * 
 * ============================================================================
 * Descrição:
 * ============================================================================
            ...
            if (this.container) {
                ...
                setTimeout(() => {
                    ...
                    if (this.currentScene) {
                        this.log('Chamando SceneManager.pop()');
                        SceneManager.pop();
                    } else {
                        this.log('⚠️ CurrentScene não existe, não pode fazer pop');
                    }
                }, 300);
            } else {
    ...
    if (AS.OptionsScreen.enabled) {
        ...
        Scene_Options.prototype.terminate = function() {
            ...
            if (this._customOptionsActive) {
                const manager = AS.PluginManager.getAgentInstance('AS_2.0_OptionsScreen');
                if (manager) {
                    manager.destroyUI();
                }
            }
