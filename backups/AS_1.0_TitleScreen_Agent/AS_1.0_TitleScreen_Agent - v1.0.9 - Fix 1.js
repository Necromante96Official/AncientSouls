    ...
    if (AS.TitleScreen.enabled) {
        ...
        Scene_Title.prototype.createCustomBackground = function() {
            ...
            logoImg.onload = () => {
                ...
                // Posiciona o logo perfeitamente centralizado no círculo/explosão do background
                // Alinhado com a explosão conforme imagem de referência (30% da altura)
                ...
                // Posiciona mais acima para ficar dentro do círculo da explosão
