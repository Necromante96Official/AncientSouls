...
/*:
 * @target MZ
 * @plugindesc [v1.0.4] Gerenciador da Tela de Título - Ancient Souls
 * @author 
 ...
 *
 * @help
 * AS_1.0_TitleScreen_Agent [v1.0.4]
 * 
 * ============================================================================
 * Descrição:
 * ============================================================================
...
(() => {
    ...
    if (AS.TitleScreen.enabled) {
        ...
        Scene_Title.prototype.createCustomBackground = function() {
            ...
            // Carrega logo do jogo (ancient-souls.png) centralizado
            ...
            logoImg.onload = () => {
                ...
                this._logoSprite.x = (Graphics.width - logoImg.width) / 2;
                this._logoSprite.y = (Graphics.height - logoImg.height) / 2;
        ...
        Scene_Title.prototype.start = function() {
            ...
            if (this._customTitleActive) {
                ...
                // Toca música apenas se não estiver desabilitada
                if (!AS.TitleScreen.disableMusic) {
                    this.playTitleMusic();
                }
