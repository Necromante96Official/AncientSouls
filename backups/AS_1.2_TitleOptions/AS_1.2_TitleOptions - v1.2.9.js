...
(() => {
    ...
    function ensureConfigExtensions() {
        ...
        ConfigManager.applyData = function(config) {
            ...
            // Jogabilidade
            this.messageSpeed = config.messageSpeed !== undefined ? resolveString(config.messageSpeed, CONFIG_DEFAULTS.messageSpeed) : CONFIG_DEFAULTS.messageSpeed;
            this.battleSpeed = config.battleSpeed !== undefined ? resolveString(config.battleSpeed, CONFIG_DEFAULTS.battleSpeed) : CONFIG_DEFAULTS.battleSpeed;
            ...
            // Otimização
            this.enableAnimations = config.enableAnimations !== undefined ? resolveBoolean(config.enableAnimations, CONFIG_DEFAULTS.enableAnimations) : CONFIG_DEFAULTS.enableAnimations;
            this.enableWeatherEffects = config.enableWeatherEffects !== undefined ? resolveBoolean(config.enableWeatherEffects, CONFIG_DEFAULTS.enableWeatherEffects) : CONFIG_DEFAULTS.enableWeatherEffects;
