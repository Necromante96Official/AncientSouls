...
/*:
 * @target MZ
 * @plugindesc v1.0.1 ☆ Sistema de Splash Screen antes da tela de título
...
(() => {
    ...
    Scene_SplashScreen.prototype.loadCurrentImage = function() {
        ...
        const imagePath = SPLASH_PATH + config.name;
        this._sprite.bitmap = ImageManager.loadBitmap('', imagePath);
