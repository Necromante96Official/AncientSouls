...
/*:
 * @target MZ
 * @plugindesc v1.0.8 ☆ Interface HTML da tela de título (layout medieval fantástico)
...
(() => {
    ...
    function createBaseLogo(logoSection) {
        ...
        baseLogo.style.transform = `translate(calc(-50% + ${baseLogoOffsetX}px), calc(-50% + ${baseLogoOffsetY}px)) scale(${baseLogoScale})`;
