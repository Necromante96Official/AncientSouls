...
/*:
 * @target MZ
 * @plugindesc v1.4.3 ☆ Interface HTML da tela de título (layout medieval fantástico)
...
(() => {
    ...
    function handleSceneReady() {
        if (!rootElement) {
            logger.warn('handleSceneReady: rootElement não encontrado!');
            return;
        }
        
        logger.info('Scene_Title pronta - ativando UI...');
        ...
        requestAnimationFrame(() => {
            ...
            logger.info('Animação de entrada aplicada.');
        });
        ...
        logger.info('UI ativada com sucesso.');
    }
    ...
    function injectMarkup() {
        ...
        // Garantir que o elemento raiz não interfira com o canvas PIXI
        ...
        logger.info(`Markup HTML inserido na árvore DOM. z-index: ${getComputedStyle(rootElement).zIndex}`);
    }
