...
/*:
 * @target MZ
 * @plugindesc v1.0.0 ☆ Sistema de Splash Screen antes da tela de título
 ...
 * 
 * IMAGENS NECESSÁRIAS:
 * - img/system/rpgmakermz.png  (primeira imagem)
 * - img/system/gamedev.png     (segunda imagem)
 * 
...
(() => {
    ...
    Scene_SplashScreen.prototype.loadCurrentImage = function() {
        ...
        this._sprite.bitmap = ImageManager.loadSystem(config.name);
