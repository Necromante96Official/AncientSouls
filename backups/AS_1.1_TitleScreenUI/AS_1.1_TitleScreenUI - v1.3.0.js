...
/*:
 * @target MZ
 * @plugindesc v1.3.0 ☆ Interface HTML da tela de título (layout medieval fantástico)
...
(() => {
    ...
    function applyLogoCustomization() {
        ...
        logoSection.style.width = 'min(1100px, 90vw)';
        logoSection.style.height = 'min(680px, 88vh)';
    ...
    function applySoulIconCustomization() {
        ...
        if (darkSoul) {
            if (darkSoulEnabled) {
                ...
                const darkTransform = `translate(-215%, -42%) translate(${darkSoulOffsetX}px, ${darkSoulOffsetY}px) scale(${darkSoulScale}) scaleX(-1)`;
        ...
        if (lightSoul) {
            if (lightSoulEnabled) {
                ...
                const lightTransform = `translate(215%, -48%) translate(${lightSoulOffsetX}px, ${lightSoulOffsetY}px) scale(${lightSoulScale})`;
    ...
    function createBaseLogo(logoSection) {
        ...
        baseLogo.style.width = '88%';
        baseLogo.style.maxWidth = '940px';
