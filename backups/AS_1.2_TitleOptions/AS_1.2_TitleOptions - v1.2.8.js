...
/*:
 * @target MZ
 * @plugindesc v1.2.8 ☆ Interface HTML moderna para opções com estética medieval fantástica
...
(() => {
    ...
    function ensureConfigExtensions() {
        ...
        ConfigManager.applyData = function(config) {
            ...
            this.muteOnFocusLoss = resolveBoolean(config.muteOnFocusLoss, CONFIG_DEFAULTS.muteOnFocusLoss);
            ...
            this.fontSize = resolveString(config.fontSize, CONFIG_DEFAULTS.fontSize);
            this.autoSaveEnabled = resolveBoolean(config.autoSaveEnabled, CONFIG_DEFAULTS.autoSaveEnabled);
            this.confirmOnExit = resolveBoolean(config.confirmOnExit, CONFIG_DEFAULTS.confirmOnExit);
            ...
            this.screenShake = resolveBoolean(config.screenShake, CONFIG_DEFAULTS.screenShake);
            
            // Visual
            this.screenFilter = resolveString(config.screenFilter, CONFIG_DEFAULTS.screenFilter);
            this.screenBrightness = resolveNumber(config.screenBrightness, CONFIG_DEFAULTS.screenBrightness, 50, 150);
            this.uiScale = resolveNumber(config.uiScale, CONFIG_DEFAULTS.uiScale, 75, 150);
            ...
            this.language = resolveString(config.language, CONFIG_DEFAULTS.language);
        };
    }
