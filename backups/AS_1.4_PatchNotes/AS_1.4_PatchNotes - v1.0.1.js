...
/*:
 * @target MZ
 * @plugindesc v1.0.1 ☆ Sistema de notas de atualização com interface medieval fantástica
...
(() => {
    ...
    function addPatchNotesButton() {
        ...
        button.innerHTML = `
            <span class="as-patchnotes-btn__icon" style="font-size: 24px; line-height: 1;">📋</span>
            <span class="as-patchnotes-btn__text" style="line-height: 1;">Atualizações</span>
        `;
        
        button.addEventListener('click', openPatchNotes);
        button.addEventListener('mouseenter', () => {
            button.style.transform = 'translateY(-2px) scale(1.05)';
            button.style.boxShadow = '0 6px 30px rgba(139, 92, 246, 0.8)';
            button.style.borderColor = '#ffe8c4';
        ...
        button.addEventListener('mouseleave', () => {
            ...
            button.style.boxShadow = '0 4px 20px rgba(139, 92, 246, 0.5)';
            button.style.borderColor = '#ffd89f';
        });
