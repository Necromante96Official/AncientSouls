...
/*:
 * @target MZ
 * @plugindesc [v1.0.4] Tela de Opções Personalizada - Ancient Souls (Redesignada)
 * @author 
...
(() => {
    ...
    class OptionsScreenManager {
        ...
        injectStyles() {
            ...
            style.textContent = `
                ...
                #as-options-container {
                    ...
                    font-family: 'Pixel Times New Roman', 'Arial Black', sans-serif;
                }
        ...
        createSliderOption(container, id, label, initialValue) {
            ...
            slider.addEventListener('input', (e) => {
                ...
                if (id === 'bgmVolume') ConfigManager.bgmVolume = value;
                if (id === 'bgsVolume') ConfigManager.bgsVolume = value;
                if (id === 'meVolume') ConfigManager.meVolume = value;
                if (id === 'seVolume') ConfigManager.seVolume = value;
    ...
    AS.PluginManager.register = AS.PluginManager.register || function(name) {};
    AS.PluginManager.getAgentInstance = AS.PluginManager.getAgentInstance || function(name) {
        if (name === 'AS_1.3_OptionsScreen' || name === 'AS_1.3_OptionsScreen_Agent') {
            if (!managerInstance) {
                managerInstance = new OptionsScreenManager();
            }
