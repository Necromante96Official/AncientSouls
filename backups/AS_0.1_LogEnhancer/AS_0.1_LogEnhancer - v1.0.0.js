...
/*:
 * @target MZ
 * @plugindesc v1.0.0 ☆ Consolida e enriquece a telemetria de logs do projeto
...
(() => {
    ...
    function currentSceneName() {
        ...
        const name = scene && scene.constructor && scene.constructor.name ? scene.constructor.name : 'Scene:?';
        return name;
    }
