...
/*:
 * @target MZ
 * @plugindesc [v1.0.6] Gerenciador da Tela de Título - Ancient Souls
 * @author 
 ...
 *
 * @help
 * AS_1.0_TitleScreen_Agent [v1.0.5]
 * 
 * ============================================================================
 * Descrição:
 * ============================================================================
    ...
    if (AS.TitleScreen.enabled) {
        ...
        Scene_Title.prototype.createCustomBackground = function() {
            ...
            logoImg.onload = () => {
                ...
                // Reduz o tamanho do logo para 45% do original
        ...
        Scene_Title.prototype.start = function() {
            ...
            if (this._customTitleActive) {
                ...
                // Toca música sempre, a menos que esteja explicitamente desabilitada
                const shouldPlayMusic = !AS.TitleScreen.disableMusic;
